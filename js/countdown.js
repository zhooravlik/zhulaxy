...
function CDT(){
 ...
 // Set countdown limit
 var tl = new Date('2016/01/18 04:20:00');

 // You can add time's up message here
 var timer = new CountdownTimer('CDT',tl,'<span class="number-wrapper"><div class="line"></div><span class="number end">Getting high!</span></span>');
 timer.countDown();
}
